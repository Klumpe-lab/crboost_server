...
# --- Configuration ---
CRYOCARE_CONTAINER="/users/artem.kushner/cryocare.sif"
...
echo "--- cryoCARE_train.py Adapter Activated ---" >&2
echo "Job Directory: $(pwd)" >&2
echo "Executing command inside cryocare.sif: cryoCARE_train.py $*" >&2
echo "---------------------------------" >&2
