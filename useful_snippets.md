...
pairs = [
    ('GT black',      '/groups/klumpe/software/Setup/Testing/test1/run12/templates/ellipsoid_550_550_550_apix11.8_black.mrc'),
    ('CURRENT black', '/users/artem.kushner/dev/crboost_server/projects/tm_gaussia_norm_fix/templates/ellipsoid_550_550_550_apix11.80_box96_lp45_black.mrc'),
    ('CURRENT seed',  '/users/artem.kushner/dev/crboost_server/projects/tm_gaussia_norm_fix/templates/ellipsoid_550_550_550_apix11.80_seed.mrc'),
]
for label, p in pairs:
    with mrcfile.open(p, permissive=True) as m:
        d = m.data
