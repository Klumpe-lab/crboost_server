...
This is precisely Phase 2+3 of the already-greenlit `docs/roadmaps/roadmap_registry-consolidation.md` — the
...
Composes with the two standing roadmaps (`docs/roadmaps/roadmap_registry-consolidation.md`, orchestrator
