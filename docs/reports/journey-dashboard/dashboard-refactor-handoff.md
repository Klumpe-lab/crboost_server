...
`docs/roadmaps/completed/roadmap_artiax-bridge.md`, `project_ux_jank_refactor`,
...
which is the ArtiaX-aligned work in `docs/roadmaps/completed/roadmap_artiax-bridge.md`).
...
selection layout. See `../../roadmaps/completed/roadmap_artiax-bridge.md`.
...
- **Gallery visual-density redesign stays DEFERRED** (user-flagged in `../../roadmaps/completed/roadmap_artiax-bridge.md`).
...
workbench slices (3b→6, see `../../roadmaps/completed/roadmap_artiax-bridge.md`) keep churning — carve it **as those slices
