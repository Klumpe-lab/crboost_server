...
The guideline is recorded in [roadmap_00-overview.md](roadmap_00-overview.md) § "Species-derived fields in a job's
...
never defaulted. Cross-reference `docs/roadmaps/completed/picking_ui/roadmap_00-overview.md`.
