...
**Peeves (maintainer, 2026-08-18):** *"'Status'. 'picks · extraction · bound jobs'. Why is
...
tmextractcand subtomo subtomoExtraction' pills are confusing and I'm not sure what are the
...
- **No cross-project persistence.** "possibly between projects" is exactly the deferred piece; the
  panel is project-scoped and says so. [07](../../picking_ui/roadmap_07-scoping-particle-registry-edges.md) records why and
