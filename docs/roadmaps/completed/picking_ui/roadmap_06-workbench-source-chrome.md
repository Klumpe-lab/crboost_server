...
import/edit current — are again very stylistically non-uniform and bigger than the title of
...
in each individual tab more compact too though, for example in the 'import' the button is at
