...
fall out of the user's walkthrough are triaged in `../roadmap_particles-ux-peeves.md`.
...
- Peeve for `../roadmap_particles-ux-peeves.md` (not S0): notes/Ø/sym inputs mutate per keystroke and each
