...
> **SUPERSEDED IN PART — read `docs/roadmaps/completed/roadmap_11-picks-actions-consolidation.md` first (2026-08-17).** This
...
`docs/roadmaps/completed/roadmap_list-extraction-and-aggregation.md`** (workflow-mapped, citations verified) — how list extraction/merge/forwarding
...
**▶▶▶ SESSION 18 — START HERE (handoff after S17, 2026-06-12). Status: P1–P7 USER-CONFIRMED at runtime ("yeah it works").
...
3. **Declutter the tab header -> tooltips + type tags (the gray-stats clutter). ✓ LANDED 2026-06-08
...
3. **Declutter the tab header -> tooltips + type tags (the gray-stats clutter).** In
   ...
   by rlnLCCmax") are AUTO-specific and confusing inline (user: "i don't know what this refers to"). MOVE
...
aggregation machinery unchanged. The edge cases in `roadmap_picks-filter-aggregation.md`
