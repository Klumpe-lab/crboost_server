...
metadata" badge (reason-bearing status records per docs/roadmaps/roadmap_task-status-state-machine.md's JSON
...
- **#38/#39 ts_alignment** — DESIGN: TiltSeriesRegistry becomes the enumeration authority; drop
  ...
  docs/roadmaps/roadmap_registry-consolidation.md; ts_alignment's migration commit is the pilot.
...
- **#68 timing** — first slice of the de-novo/Journey UI pass, backend + UI together (never a
  hidden backend half): `docs/roadmaps/completed/roadmap_07-extract-pick-list-job-identity.md`. #73 stays gated on it.
...
Verdicts against the claims written in roadmap_04-driver-consolidation.md (line numbers there predate the Aug 11–12 edits).
...
HOW docs/roadmaps/roadmap_task-status-state-machine.md CONSTRAINS THIS CONSOLIDATION:
