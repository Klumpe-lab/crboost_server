...
`/groups/klumpe/crboost_data/<user>_Aug27` (a user's 114-TS run). **Not implemented.**
...
Project `/groups/klumpe/crboost_data/<user>_Aug27`, job `External/job004`
(`aligntiltsWarp`, 114 tilt-series). 62 of 114 array tasks failed with:

```
FATAL ERROR for ts=<user>_Aug27_Position_1_2: Cannot align '...':
...
- **The orchestrator replacement** (`roadmap_orchestrator-replacement.md`). S1–S4 must hold under both
