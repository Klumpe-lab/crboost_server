...
| 04 | [driver-consolidation](04-driver-consolidation.md) | ArrayDriver template, ToolCommand, one status protocol | medium (behavior-preserving by construction, per-driver rollout) | **stages 0–1 done** — census + `TaskStatusStore` runtime-verified 2026-08-13; stage-2 design drafted ([design](04-stage2-toolcommand-design.md), [transcripts](04-stage2-transcripts.md)) awaiting maintainer review |
