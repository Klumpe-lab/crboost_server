...
| 01 | [service-boundary](01-service-boundary.md) | Facade becomes real; QC/visualization processing gets its own home; undo the services→ui inversion | low (mechanical moves) | in progress — stages 0–3 done (2026-08-11); next: stage 4 persistence-through-facade |
