...
refreshes. Same approach as ui/job_plugins/_field_styles.py.
...
New UI must use this instead of ad-hoc `color=primary` / styled `ui.button`s.
"""
...
def house_button(
    ...
    *,
    ...
    # vocabulary is `Curate picks`, where the glyph is the door to ArtiaX.
